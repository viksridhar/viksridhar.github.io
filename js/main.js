...
var api = GeotabApi(function (authenticationCallback) {
    ...
    document.getElementById("s1").addEventListener("click", function () {
        ...
        /*server = "https://preview1.geotab.com",
        userName = "sridhar.narasimhan8@gmail.com",
        password = "geotab1234",
        database = "ati_hos";*/
...
elt.innerHTML = `<input type="text" id="s1" name="s1">`

elt.querySelector("#s1").value="gunalan";
    ...
    if (resultd != null && resultd.length > 0) {


          console.log("Donesa: ", resultd);

       // alert(JSON.stringify(resultd[0]));
        document.getElementById("s1").value=JSON.stringify(resultd[0].driver);
//document.write(JSON.stringify(resultd[0].driver));
   //return JSON.stringify(resultd[0]);
